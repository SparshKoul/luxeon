...
const Home = () => {
  ...
  // Implement original JavaScript functionality in React
  useEffect(() => {
  ...
  }, [collections]); // Re-run when collections are loaded
  ...
  return (
    <div>
      {/* Hero (rewritten from scratch to static HTML matching original) */}
        ...
        <div className="container">
          ...
          <div className="section-footer">
            <button
              ...
              style={{ display: showAllCollections ? "none" : "inline-block" }}
            >
          ...
          <div className="about-wrapper">
            ...
            <div className="about-content">
              ...
              <p className="about-description">
                ...
                of our planet. Each piece is crafted with intention, quality,
                and an understanding of what today's generation values.
              </p>
              <p className="about-description">
          ...
          <div className="testimonials-grid">
            ...
            <div className="testimonial-card">
              ...
              <p className="testimonial-text">
                "Obsessed with my new Luxeon pieces! The quality is amazing and
      ...
      <section className="instagram">
        <div className="container">
          <div className="section-header">
            ...
            <p className="section-description">
              Join us on Instagram @luxeon_style for daily inspiration and first
              looks.
            </p>
          </div>
